...
// Consulta SQL para pegar as empresas cadastradas
$sql = "SELECT idempresa, nomeempresa FROM empresas";
...
<body>
    ...
    <div class="container table-container">
        <h2>Formulário Disponível</h2>
        <a href="formulariousu.php" class="btn btn-primary">Acessar Formulário de Denúncia para VIncular a Empresa</a>
    </div>
