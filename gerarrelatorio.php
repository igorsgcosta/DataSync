                    ...
                    <?php
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . htmlspecialchars($row['niveldeacesso']) . "</td>";
                                echo "<td>
                                        <a href='editar_usuario.php?id=" . urlencode($row['usuario']) . "' class='btn btn-primary btn-sm'>Editar</a>
                                        <a href='excluir_usuario.php?id=" . urlencode($row['usuario']) . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Tem certeza que deseja excluir este usuário?');\">Excluir</a>
                                    </td>";
                                echo "</tr>";
                            }
                        } else {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            <label for="setor" class="form-label">Empresa</label>
                            <input type="text" class="form-control" id="setor" placeholder="Digite a Empresa">
                        </div>
