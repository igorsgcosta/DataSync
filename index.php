...
<head>
    ...
    <style>
        * {
        ...
        #assédio-e-violência .interface {
            flex-direction: column;
            align-items: center;
        }

        #assédio-e-violência h1 {
            font-size: 2em;
            margin-bottom: 20px;
            text-align: center;
            color: #333;
        ...
        #assédio-e-violência h2 {
            font-size: 1.5em;
            margin: 20px 0;
            color: #444;
        }

        #assédio-e-violência p {
            font-size: 1em;
            line-height: 1.6;
            color: #555;
            margin-bottom: 20px;
        ...
        #assédio-e-violência ul {
            list-style-type: disc;
            margin: 20px 0;
            padding-left: 20px;
        }

        #assédio-e-violência ul li {
            margin-bottom: 10px;
        }
...
<body>
    ...
    <!-- Seção sobre assédio e violências no trabalho -->
    <section id="assédio-e-violência">
        <div class="interface">
            <h1>Assédio e Outras Violências no Trabalho</h1>
            <p>O assédio e outras formas de violência no ambiente de trabalho são sérios problemas que afetam a saúde e o bem-estar dos colaboradores. É fundamental estar ciente das diferentes formas de violência e das medidas que podem ser tomadas para prevenir e enfrentar essas situações.</p>

            <h2>Tipos de Assédio e Violências</h2>
            <ul>
                <li><strong>Assédio Moral:</strong> Atitudes e comportamentos que humilham e constrangem um indivíduo, afetando sua dignidade e autoestima.</li>
                <li><strong>Assédio Sexual:</strong> Avanços ou comportamentos de natureza sexual que criam um ambiente hostil ou constrangedor.</li>
                <li><strong>Assédio Psicológico:</strong> Atos que visam controlar ou manipular a mente do indivíduo, como intimidação e ameaças.</li>
            </ul>

            <h2>Como Denunciar</h2>
            <p>Se você ou alguém que você conhece está passando por assédio ou outra forma de violência no trabalho, é importante fazer a denúncia. A empresa deve ter um canal de denúncia confiável e anônimo para esses casos. Caso não haja uma política clara na empresa, você pode buscar apoio em entidades externas especializadas.</p>

            <h2>Recursos e Apoio</h2>
            <p>Além das políticas internas da empresa, existem diversas organizações e entidades que oferecem suporte para vítimas de assédio e violência no trabalho. Informe-se sobre as opções disponíveis e não hesite em buscar ajuda.</p>
        </div>
    </section>

    <!-- Seção sobre leis e normas -->
    <section id="leis-normas">
        <div class="interface">
            <h1>Leis e Normas Relacionadas</h1>
            <p>Conhecer as leis e normas que regulamentam o assédio e outras formas de violência no ambiente de trabalho é essencial para garantir um ambiente seguro e justo para todos os colaboradores. A seguir, listamos algumas das principais leis e normas relevantes.</p>

            <h2>Legislação Brasileira</h2>
            <ul>
                <li><strong>Constituição Federal:</strong> Artigos sobre direitos fundamentais e proteção contra discriminação e violência.</li>
                <li><strong>Lei nº 9.799/1999:</strong> Lei que prevê a criação de mecanismos para prevenção e combate ao assédio no ambiente de trabalho.</li>
                <li><strong>Lei nº 13.467/2017 (Reforma Trabalhista):</strong> Inclui disposições sobre a responsabilidade do empregador em casos de assédio e violência no trabalho.</li>
                <li><strong>Lei nº 11.340/2006 (Lei Maria da Penha):</strong> Protege as mulheres contra violência doméstica e pode ser relevante para situações de violência que refletem no ambiente de trabalho.</li>
            </ul>

            <h2>Normas Internacionais</h2>
            <ul>
                <li><strong>Convenção nº 190 da OIT:</strong> Convenção sobre a eliminação da violência e assédio no mundo do trabalho.</li>
                <li><strong>Declaração da OIT sobre Princípios e Direitos Fundamentais no Trabalho:</strong> Define princípios fundamentais relacionados ao respeito pelos direitos dos trabalhadores.</li>
            </ul>

            <p>É importante que todos os colaboradores e empregadores estejam cientes dessas leis e normas para promover um ambiente de trabalho seguro e respeitoso.</p>
        </div>
    </section>
