    ...
    <div class="container table-container">
        ...
        <table class="table table-bordered" id="denunciasTable">
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-primary" onclick="iniciarInvestigacao(this)">Reabrir</button>
                    <button class="btn btn-danger btn-archivar" disabled>Arquivada</button>
        ...
        <button class="btn btn-secondary btn-download" onclick="downloadTable()">Download Tabela</button>
    </div>
