...
<body>
    ...
    <div class="container my-4">
        <h2 class="text-center text-primary">PLANO / CRONOGRAMA DE AÇÕES</h2>
        <div class="container my-4">
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#planModal">
                Criar Ação
            </button>
        </div>
...
<div id="planModal" class="modal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Plano / Cronograma de Ações</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <label for="nomeCronograma" class="form-label">Nome do Plano de Ação</label>
                            <input type="text" class="form-control" id="nomeCronograma" placeholder="">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="dataElaboracao" class="form-label">Data de Elaboração</label>
                            <input type="date" class="form-control" id="dataElaboracao" value="2024-11-26">
                        </div>
                        <div class="col-md-4">
                            <label for="modo" class="form-label">Modo</label>
                            <select id="modo" class="form-select">
                                <option value="rascunho" selected>Rascunho (Editável)</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="tipo" class="form-select">
                                <option value="5w2h" selected>5W2H</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="acao" class="form-label">O quê / Ação</label>
                            <textarea id="acao" class="form-control" rows="3"></textarea>
                        </div>
                        <div class="col-md-4">
                            <label for="porque" class="form-label">Por quê</label>
                            <textarea id="porque" class="form-control" rows="3"></textarea>
                        </div>
                        <div class="col-md-4">
                            <label for="onde" class="form-label">Onde</label>
                            <textarea id="onde" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="como" class="form-label">Como será feito</label>
                            <textarea id="como" class="form-control" rows="3"></textarea>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" id="dataExecucao" class="form-control">
                        </div>
                        <div class="col-md-2">
