...
if ($result_check_cpf->num_rows > 0) {
    // CPF já cadastrado, exibe uma mensagem de aviso e redireciona
    echo "<script>alert('CPF já cadastrado! Por favor, verifique os dados e tente novamente.'); window.location.href='paineldesevolvedor.php';</script>";
    exit();
}
...
if ($stmt_insert->execute()) {
    // Usuário salvo com sucesso, exibe uma mensagem de sucesso e redireciona
    echo "<script>alert('Usuário cadastrado com sucesso!'); window.location.href='paineldesevolvedor.php';</script>";
    exit();
} else {
